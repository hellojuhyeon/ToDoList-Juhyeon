...
function addContentInputEvent(todoContent, todoCode) {
	const todoContentText = todoContents.querySelector(".todo-content-text");
	const todoContentInput = todoContents.querySelector(".todo-content-input");
	...
	let updateTodo = () => {
		...
		if(getChangeStatusOfValue(todoContentValue, todoContentNewValue)){
...
function getTodoContentValueChangeStatus(originValue, newValue){
...
function removeAlltypeSelected(elements, className){
